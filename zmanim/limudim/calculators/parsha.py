...
class Parsha(LimudCalculator):
    ...
    IsraelModifications = {
                ...
                (2, Kviah.chaseirim, 3): [['vayakheil', 'pekudei'], ['tazria', 'metzora'], ['acharei', 'kedoshim'],
                                          ['behar', 'bechukosai'], ['matos', 'masei'], ['nitzavim', 'vayeilech']],
                (2, Kviah.shelaimim, 5): [['vayakheil', 'pekudei'], ['tazria', 'metzora'], ['acharei', 'kedoshim'],
                                          ['behar', 'bechukosai'], ['matos', 'masei'], ['nitzavim', 'vayeilech']],
                (3, Kviah.kesidran, 5): [['vayakheil', 'pekudei'], ['tazria', 'metzora'], ['acharei', 'kedoshim'],
                                         ['behar', 'bechukosai'], ['matos', 'masei'], ['nitzavim', 'vayeilech']],
                (5, Kviah.kesidran, 7): [['vayakheil', 'pekudei'], ['tazria', 'metzora'], ['acharei', 'kedoshim'],
                                         ['matos', 'masei']],
                (5, Kviah.shelaimim, 1): [['tazria', 'metzora'], ['acharei', 'kedoshim'], ['behar', 'bechukosai'],
                                          ['matos', 'masei']],
                (7, Kviah.chaseirim, 1): [['vayakheil', 'pekudei'], ['tazria', 'metzora'], ['acharei', 'kedoshim'],
                                          ['behar', 'bechukosai'], ['matos', 'masei']],
                (7, Kviah.shelaimim, 3): [['vayakheil', 'pekudei'], ['tazria', 'metzora'], ['acharei', 'kedoshim'],
                                          ['behar', 'bechukosai'], ['matos', 'masei']],
            }
